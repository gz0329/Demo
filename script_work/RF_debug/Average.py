...
f1 = open("Direct_2cable_test_2to4Ghz_-20to0dBm_A.csv", "r")
f2 = open("Direct_2cable_test_2to4Ghz_-20to0dBm_B.csv", "r")
f3 = open("Direct_2cable_test_2to4Ghz_-20to0dBm_C.csv", "r")

f = open("Direct_2cable_test_2to4Ghz_-20to0dBm_Mean.csv", "w")
